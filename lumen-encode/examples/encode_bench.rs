...
fn main() {
    ...
    bench(
        w, h, frames,
        OpenH264Config { threads: 0, complexity: lumen_encode::openh264::Complexity::Low, ..Default::default() },
    ...
    bench(
        ...
        OpenH264Config {
            threads: 8,
            complexity: lumen_encode::openh264::Complexity::Low,
            skip_frames: true,
            ..Default::default()
        },
    ...
    bench(
        ...
        OpenH264Config {
            threads: 0,
            usage_type: lumen_encode::openh264::UsageType::CameraVideoRealTime,
            complexity: lumen_encode::openh264::Complexity::Low,
            ..Default::default()
        },
