//! Interop test: pair against the Go `doubletake-test-receiver` binary.
//!
//! Usage:
...
use dt_airplay::info::ReceiverInfo;
use dt_airplay::pairing::PairingSession;
use dt_airplay::transport::{TcpTransport, Transport};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut session = PairingSession::new(dt_airplay::uuid::generate_uuid());
